...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/royal-dream-86fe
```

A live public deployment of this template is available at [https://royal-dream-86fe.templates.workers.dev](https://royal-dream-86fe.templates.workers.dev)
